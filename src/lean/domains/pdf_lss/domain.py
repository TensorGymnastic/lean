...
from lean.core.config import CoreSettings
...
from lean.core.transports import DomainRegistration
from lean.core.vlm import OpenAICompatibleVLM
from lean.domains.pdf_lss.prompts import CHART_EXTRACTION_PROMPT, parse_description
...
def _lss_extractors(settings: LssSettings) -> list[Any]:
    ...
    from lean.core.extraction import Extractor
